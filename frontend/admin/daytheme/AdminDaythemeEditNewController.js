...
module.controller('AdminDaythemeEditNewController', function (Page, AdminDaytheme, $stateParams, $rootScope, $scope, $location, $window, $timeout) {
    ...
    $scope.daytheme.eventgroup_id = $scope.eventgroup_id;
            ...
            $scope.daytheme.$update(function (res) {
