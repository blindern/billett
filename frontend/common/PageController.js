...
// global page
module.controller('PageController', function (AuthService, Page, $scope, $location, $rootScope) {
    $scope.isAdminPage = function () {
        return $location.path().substring(0, 3) == '/a/';
    };

    $scope.isDevPage = $scope.isDibsTest = $scope.isLoggedIn = $scope.loggedInButNoAccess = false;
